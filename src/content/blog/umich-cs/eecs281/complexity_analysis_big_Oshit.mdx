...
there is literally a lecture vid on this... go watch that shit man..

what does it mean for a function to be logarithmic 


---
https://stackoverflow.com/questions/8870442/how-is-math-pow-implemented-in-net-framework

https://stackoverflow.com/questions/12483379/do-power-functions-run-in-constant-time

```cpp
int power(int x, uint32_t n)

// write this iteratively & recursively, logarithmically


```

the goal here is to solve recurrence relations ^
...
lab slide examples:
https://umich.instructure.com/courses/802082/files/folder/Lab/lab02/Lab%20Slides?preview=44510753