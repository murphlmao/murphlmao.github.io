...
export default function BlogPagination({ articles, articlesPerPage }: BlogPaginationProps) {
            ...
            >
              <div className="md:col-span-3 group relative flex flex-col items-start">
                <h2 className="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
                  ...
                  <a href={`/articles/${article.slug}`} className="hover:text-sky-500 dark:hover:text-sky-400">
