// @ts-nocheck
/* Ported verbatim from docs/redesign-previews/r4/critters.js; the r4 IIFE body is now the
   body of initCritters(). r4's own inner `initCritters` (the one on
   window.Critters.init) keeps its name and shadows the export inside this body,
   exactly as it resolved inside the IIFE. r4's header comment follows. */
/* r4 — critters.js
